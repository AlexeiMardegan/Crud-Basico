    ...
    <div class="row justify-content-center row-cols-1 row-cols-md-2 mb-3 text-center">
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3" id="pesquisalouca">
                ...
                <div class="card-body text-start">
                    <?php
                        ...
                        if($pos !== false){
                            ...
                            echo '<label class="form-label">RG</label><br />';
                            echo '<label class="form-label"><b>'.$dados[$pos+2].'</b></label><br />';
                            
                        } else {
                            echo "Não foi encontrado nenhum registro!<br/>";
                        }
                    ?>
                    <a href="index.php" class="btn btn-outline-secondary" id="voltar">Voltar</a>
                </div>
            </div>
        </div>
    </div>
